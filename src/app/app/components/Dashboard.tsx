...
export default function Dashboard() {
    const { transactions, loading, refreshTransactions, getTransactionsByMonth, getTotalIncome, getTotalExpenses, getBalance, getCategoryTotals } = useTransactions()
        ...
        <div className="dashboard">
            ...
            <div className="recent-section">
                ...
                <TransactionList
                    ...
                    onCategoryChanged={() => refreshTransactions()}
                    showDate
                />
            </div>
            ...
            <style jsx>{`
                ...
                .bank-connect { background: var(--bg-card); border-radius: var(--radius-lg); padding: 1.25rem 1.5rem; border: 1px solid var(--border-color); }
